...
<body>
	<div class="module_title" >编辑用户信息</div>
	<form:form action="${basePath }/userController/submitUser.do"  method="post" commandName="srModel" >
	<form:hidden path="id" />
	<table class="mytb" width="60%" >
		...
		<%-- <tr>
			...
			<td><form:password path="userPwd" class="ipt" /> </td>
		</tr> --%>
		<tr>
